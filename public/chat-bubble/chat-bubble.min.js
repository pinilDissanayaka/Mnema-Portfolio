...
(function () {
  ...
  const icons = {
    messageCircle:
      '<span class="chat-bubble-icon" style="width:100%;height:100%;border-radius:50%;background:#ffffff;display:inline-flex;align-items:center;justify-content:center;overflow:hidden;"><img src="/chat-bubble/bot-icon.png" alt="bot" style="display:block;width:100%;height:100%;object-fit:cover;"/></span>',
  ...
  bot: '<img src="/chat-bubble/bot-icon.png" alt="bot" class="bot-icon" />',
